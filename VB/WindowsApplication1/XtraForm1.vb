...
Namespace WindowsApplication1
	Partial Public Class XtraForm1
        ...
        Public Sub New(ByVal pattern As Appointment, ByVal fdow As DevExpress.XtraScheduler.FirstDayOfWeek, ByVal afc As AppointmentFormController)
        ...
        Protected Overrides Sub InitializeControls(ByVal firstDayOfWeek As DevExpress.XtraScheduler.FirstDayOfWeek)
            InitializeComponent()
